...
class WP_Plugin_Licencing_Post_Types {
	...
	public function input_file( $key, $field ) {
		...
		<p class="form-field">
			...
			<button class="button upload_image_button" data-uploader_button_text="<?php _e( 'Use file', 'wp-plugin-licencing' ); ?>"><?php _e( 'Upload', 'wp-plugin-licencing' ); ?></button> <?php if ( ! empty( $field['description'] ) ) : ?>
